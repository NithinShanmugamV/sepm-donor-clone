...
function mlval(value,[messages, setMessages]){
	var neg5 = [
        "abandon",
        "bastard",
        "bastards",
      ...
      function analyze() {
       ...
       var totalLex = sentNeg5 + sentNeg4 + sentNeg3 + sentNeg2 + sentNeg1 + sentPos1 + sentPos2 + sentPos3 + sentPos4 + sentPos5;
        ...
        //🤬☹️🙁😐🙂😊😃😄😀😁
        var sent2 = (document.getElementById("out1").innerHTML = sentFace);
        if(sentimentAvg > -3){
...
function ChatScreen() {
    ...
    const handleSend = e => {
        ...
        mlval(input,[messages, setMessages]);
        ...
        <div className="chatScreen">
            ...
            <div>
                <form className="chatScreen__input" id="userInput">
                    ...
                    <div className="chatScreen__output" id="out">0</div>
                    <div className="chatScreen__output" id="out1">0</div>
